...
async function main() {
    ...
    const venue = await prisma.venue.create({
        data: {
            name: "Escape Dhaka",
            description: "A real-world escape room experience with challenging puzzles and immersive rooms.",
    ...
    const hauntedRoom = await prisma.room.create({
        data: {
            ...
            description: "A mysterious mansion filled with hidden clues, puzzles and unexpected surprises.",
            capacity: 6,
            price: 2500,
            duration: 60,
            difficulty: "HARD",
    ...
    const bankRoom = await prisma.room.create({
        data: {
            name: "The Bank Heist",
            description: "Break into the vault, solve the security puzzles and escape before time runs out.",
            capacity: 8,
            price: 3000,
            duration: 75,
            difficulty: "MEDIUM",
    ...
    const prisonRoom = await prisma.room.create({
        data: {
            name: "Prison Break",
            description: "You have been locked inside a high-security prison. Find your way out.",
            capacity: 6,
            price: 2200,
            duration: 60,
            difficulty: "EASY",
    ...
    // TIME SLOTS
    // --------------------------------------------------
    const createTimeSlot = (roomId, date, startHour, startMinute, duration) => {
