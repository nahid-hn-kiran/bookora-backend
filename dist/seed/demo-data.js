import { BookingStatus, PaymentMethod, PaymentStatus, Role, RoomStatus, UserStatus, VenueStatus, } from "../generated/prisma/enums";
...
const image = (photoId) => `https://images.unsplash.com/${photoId}?auto=format&fit=crop&w=1600&q=85`;
const venues = [
    {
        id: demoIds.venueNorth,
        name: "Cipher House Gulshan",
        description: "A polished escape-room studio in the heart of Gulshan, pairing cinematic sets with carefully crafted puzzles for private groups, celebrations, and team nights.",
    ...
    },
    {
        ...
        description: "An atmospheric riverside venue built for immersive games, with welcoming hosts, dramatic rooms, and comfortable space for groups to gather before and after a mission.",
    ...
    },
    {
        ...
        description: "A warm, story-led escape destination where vintage details, inventive props, and helpful game masters make every room feel like a different world.",
...
const rooms = [
    {
        ...
        description: "A celebrated historian vanished after leaving one unfinished case behind. Follow a trail of coded letters, hidden compartments, and a missing final chapter before the archive is sealed forever.",
        capacity: 6,
        price: 3200,
        duration: 60,
        difficulty: "MEDIUM",
    ...
    },
    {
        ...
        description: "The last train is waiting, but its destination has been erased. Reconstruct the conductor's route, restore the station clock, and uncover why every passenger left in such a hurry.",
        capacity: 8,
        price: 3600,
        duration: 75,
        difficulty: "HARD",
    ...
    },
    {
        ...
        description: "A private collection is about to be auctioned, but the most valuable artifact is missing. Navigate a gallery of false leads and clever mechanisms to find the original before the buyers arrive.",
        capacity: 5,
        price: 2900,
        duration: 60,
        difficulty: "EASY",
    ...
    },
    {
        ...
        description: "A storm has cut communication with an offshore research station. Decode the emergency logs, stabilise the control room, and transmit the rescue coordinates before the tide turns.",
        capacity: 7,
        price: 4100,
        duration: 75,
        difficulty: "EXPERT",
    ...
    },
    {
        ...
        description: "Inside a master clockmaker's workshop, every machine tells a different version of the same hour. Align the moving parts and solve the paradox before the workshop resets.",
        capacity: 6,
        price: 3400,
        duration: 60,
        difficulty: "HARD",
    ...
    },
    {
        ...
        description: "A weather bureau's prototype can predict the city's next great storm, but its launch sequence is locked. Assemble the forecast from field notes and bring the system online.",
        capacity: 10,
        price: 3800,
        duration: 60,
        difficulty: "MEDIUM",
    ...
    },
    {
        ...
        description: "A courier's final letter contains a secret route through centuries of trade. Trace the symbols, open the travelling trunk, and deliver the message before its story is lost.",
        capacity: 6,
        price: 3000,
        duration: 60,
        difficulty: "MEDIUM",
    ...
    },
    {
        ...
        description: "A rare night-blooming specimen is ready to open, but the botanist has disappeared. Read the garden's clues, restore the greenhouse controls, and protect the discovery.",
        capacity: 5,
        price: 2800,
        duration: 60,
        difficulty: "EASY",
    ...
    },
    {
        ...
        venueId: demoIds.venueOldTown,
        name: "The Red Ledger",
        description: "A vanished accountant left behind one ledger and a room full of contradictions. Reconcile the accounts, expose the hidden network, and leave with the evidence intact.",
        capacity: 8,
        price: 3500,
        duration: 75,
        difficulty: "HARD",
    ...
    },
    {
        ...
        description: "The observatory's great lens has captured an impossible signal. Calibrate the instruments, map the stars, and determine what is waiting beyond the last constellation.",
        capacity: 7,
        price: 3900,
        duration: 75,
        difficulty: "EXPERT",
...
async function main() {
    ...
    const slotFor = (roomId, dayOffset, slotIndex) => timeSlots.find((slot) => slot.roomId === roomId &&
    ...
    for (const definition of bookingDefinitions) {
        ...
        const booking = await prisma.booking.upsert({
            ...
            update: {
                ...
                expiresAt: definition.status === BookingStatus.PENDING
    ...
    console.log(`Demo data ready: ${venues.length} venues, ${rooms.length} rooms, ${timeSlots.length} time slots, ${bookingDefinitions.length} bookings.`);
}
main()
    .catch((error) => {
