...
router.patch("/users/:id", checkAuth(Role.ADMIN, Role.SUPER_ADMIN), validateRequest(updateUserZodSchema), AdminController.updateUser);
router.delete("/users/:id", checkAuth(Role.ADMIN, Role.SUPER_ADMIN), AdminController.deleteUser);
