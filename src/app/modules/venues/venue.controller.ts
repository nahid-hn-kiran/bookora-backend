...
const getVenues = catchAsync(async (req: Request, res: Response) => {
...
const getVenueById = catchAsync(async (req: Request, res: Response) => {
...
const deleteVenue = catchAsync(async (req: Request, res: Response) => {
  const result = await venueService.deleteVenue(req.params.id as string);
